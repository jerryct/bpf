...
int main(void) {
  ...
  relocate_map_fd(funclatency_entry_prog, funclatency_entry_prog_len, 0x23, mfd);
  ...
  relocate_map_fd(funclatency_prog_exit, funclatency_exit_prog_len, 0x23, mfd);
  relocate_map_fd(funclatency_prog_exit, funclatency_exit_prog_len, 0x42, sfd);
